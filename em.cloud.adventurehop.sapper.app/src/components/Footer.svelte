                ...
                <div class="col-4 mb-3">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-1.jpg"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-4 mb-3">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-2.jpg"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-4 mb-3">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-3.jpg"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-4">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-4.jpg"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-4">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-5.jpg"></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-4">
                  <div class="media media-hover">
                    <div class="content w-100">
                      ...
                      <a class="media-img-overlay" data-fancybox="gallery" href="assets/img/home/gallery/gallery-6.jpg"></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-lg-3 mt-lg-4">
              ...
              <form class="mb-6" action="index.html" method="post">
                <div class="input-group input-group-sm">
                  <input type="email" class="form-control form-control-sm form-transparent" required="" placeholder="Enter your email">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 order-1 order-md-0">
              <p class="mb-0 mb-md-0 text-md-left">Copyright &copy; 2019 All Rights Reserved by
